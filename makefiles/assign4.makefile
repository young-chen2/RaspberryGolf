...
APPLICATION = build/heap_workflow.bin
TEST 		= build/test_backtrace_malloc.bin

all: $(APPLICATION) $(TEST)

# Object files needed to build the application binary.
OBJECTS = $(addprefix build/, $(MY_MODULES) start.o cstart.o nameless.o)
...
build/nameless.o: CFLAGS += -mno-poke-function-name
...
-include assign4-grading.makefile
